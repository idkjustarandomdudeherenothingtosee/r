...
if not isfolder("Light Hub") then
    makefolder("Light Hub")
end
if not isfolder("Light Hub/Config") then
    makefolder("Light Hub/Config")
end
...
local ConfigFile = "Light Hub/Config/Light Hub_" .. gameName .. ".json"
...
function Chloex:MakeNotify(NotifyConfig)
    ...
    NotifyConfig.Title = NotifyConfig.Title or "Light Hub"
...
function Chloex:Window(GuiConfig)
    ...
    GuiConfig.Title        = GuiConfig.Title or "Light Hub"
    GuiConfig.Footer       = GuiConfig.Footer or "Light Hub"
